            ...
            <div class="flex-1 overflow-x-auto">
                <table class="min-w-full text-xs text-left text-gray-500">
                    <thead class="bg-gray-50 text-gray-700 uppercase font-semibold border-b">
                        <tr>
                            <th class="px-4 py-3">No. Tujuan</th>
                            <th class="px-4 py-3">Tipe</th>
                            <th class="px-4 py-3">Status</th>
                            <th class="px-4 py-3">Tanggal Antre</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 font-medium text-gray-900">{{ $notif->to_phone }}</td>
                            ...
                            <td class="px-4 py-3 text-gray-400">{{ $notif->created_at->diffForHumans() }}</td>
                            <td class="px-4 py-3 text-red-500 max-w-xs truncate" title="{{ $notif->last_error ?? '' }}">
                                {{ $notif->last_error ?? '-' }}
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="5" class="px-4 py-8 text-center text-gray-400">Belum ada antrean notifikasi yang tercatat.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
